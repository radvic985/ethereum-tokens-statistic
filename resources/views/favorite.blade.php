    ...
    <div class="container">
        <div class="row">
            <div class="main-title">
                <span id="table-title">Whale Watch</span>
        ...
        <div class="row main-row">
            <div class="tables-wrapper">
                        ...
                        <table class="table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th id="name" class="td-sort ch2">
                                    Whale
                                    <span class="sort-icon"><i class="fas fa-caret-down"></i><i
                ...
                <div class="table-first">
                            ...
                            <tr>
                                <th id="balance" class="td-sort ch3"><span class="span-balance">Balance(mil)</span>
                                    <span class="sort-icon">
                                        <i class="fas fa-caret-down down"></i><i class="fas fa-caret-up down"></i>
                                    </span>
                                </th>
                                <th class="ch4">
                    ...
                    <table class="table-whale main-table table-striped table-bordered table-hover table-condensed">
                        <tbody>
                        @foreach($whales as $whale)
                            <tr>
                                <td class="c3">{{Whale::getBalanceByMillion($whale['balance'])}}</td>
                                <td class="c4">{!!$whale['top_holdings']!!}</td>
                                <td class="c5"><?=$whale['total_tokens']?></td>
                                <td class="c6">{{Whale::getLastActive($whale['last_active'])}}</td>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:10px">
                    <textarea name="notice-text" id="notice-text" cols="34"
                              rows="5">Please, enter your notice</textarea>
                </div>
