...
class GetTopTransfers extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'top_transfers';
     ...
     * @var string
     */
    protected $description = 'Get top transfers';
    ...
    {
//        \Log::info('TOP TRANSFERS START - ' . \Carbon\Carbon::now());
...
//            \Log::info('TOPPPPPPPPP TRANSFERS index - ' . $ii . " - " . \Carbon\Carbon::now());
...
//            $ii++;
//            \Log::info('TOPPPPPPPPP END FOREACH index - ' . $ii . " - " . \Carbon\Carbon::now());
        }
//        \Log::info('TOP TRANSFERS END  - ' . \Carbon\Carbon::now());
    }
}
